 ...
 */
package com.jewer.dronedetectcompose.home
...
import com.jewer.dronedetectcompose.composables.TabsTopBar
import com.jewer.dronedetectcompose.home.camera.CameraView
import com.jewer.dronedetectcompose.home.gallery.GalleryView
...
fun HomeScreen(
    ...
    Column {
        ...
        Box(
            ...
            Text(text = "推理時間: $inferenceTime ms")
        }
    }
}
