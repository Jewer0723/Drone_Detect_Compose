 ...
 */
package com.jewer.dronedetectcompose.objectdetector
...
class ObjectDetectorHelper(
    ...
    var currentModel: Int = DRONE_MOBILENET_V2,
    ...
    fun setupObjectDetector() {
        ...
        val modelName =
            when (currentModel) {
                DRONE_MOBILENET_V2 -> "drone_mobilenet_v2_V2.tflite"
                DRONE_MOBILENET_V2_FP16 -> "drone_mobilenet_v2_fp16_V1.tflite"
                LIFESTUFF_MOBILENET_V1 -> "lifestuff_mobilenet_v1.tflite"
                else -> "drone_mobilenet_v2_V2.tflite"
            }
    ...
    companion object {
        ...
        const val DRONE_MOBILENET_V2 = 0
        const val DRONE_MOBILENET_V2_FP16 = 1
        const val LIFESTUFF_MOBILENET_V1 = 2
